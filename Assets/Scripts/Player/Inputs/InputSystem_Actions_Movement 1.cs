...
//     version 1.18.0
//     from Assets/StudiosAZE/Advanced First Person Movement System/Inputs/InputSystem_Actions_Movement 1.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/StudiosAZE/Advanced First Person Movement System/Inputs/InputSystem_Actions_Movement 1.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @InputSystem_Actions_Movement1: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @InputSystem_Actions_Movement1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""InputSystem_Actions_Movement 1"",
    ""maps"": [
        {
            ""name"": ""Player"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""9507e8ff-45af-41d7-8d83-5e3bd70c9749"",
                ...
                {
                    ""name"": """",
                    ""id"": ""f3f181ee-6233-40ac-893e-87eb8d7f5793"",
    ...
    ~@InputSystem_Actions_Movement1()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, InputSystem_Actions_Movement1.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputSystem_Actions_Movement1.UI.Disable() has not been called.");
    }
    ...
    {
        private @InputSystem_Actions_Movement1 m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@InputSystem_Actions_Movement1 wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@InputSystem_Actions_Movement1 wrapper) { m_Wrapper = wrapper; }
        /// <summary>
